...
class Header extends React.Component {
   constructor(props){
     super(props);
     this.state={value:'null', flag:'', value1:'null'}
    ...
    return (
      <thead>
          <tr>
              ...
              <th>Название
              <form>
                 <input type="text" placeholder="Поиск по задачам.." onChange={this.searchTasks.bind(this,title)}/>
              </form>
              ...
              <form  onSubmit={this.handleSubmitUser}>
                <select value={this.state.value} onChange={this.handleChangeUser.bind(this,user)}>
              ...
              <form onSubmit={this.handleSubmitStatus}>
                  <select value={this.state.value1} onChange={this.handleChangeStatus.bind(this,status)}>
                  <option value = {'null'}>Все</option>
                    {
